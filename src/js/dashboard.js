...
// Comment out all the database enrollment functionality
/*
...
function moveToEnrolledSection(courseName) {
  ...
  enrolledDiv
    .querySelector(".access-course-btn")
...
// Remove this code as we're now adding event listeners inside loadCourses
/*
const enrolled = document.querySelector(".html-btn");
if (enrolled) {
